export function cors (req, res, next) {
  ...
  const ACCEPTED_ORIGINS = ['http://localhost:5173', 'http://localhost:5174', 'http://localhost:5175', 'https://neon-dragon-b1bc62.netlify.app', 'https://nodeapi-v7dd.onrender.com', 'https://zenmarks.xyz/', 'https://zenmarks.vercel.app']
